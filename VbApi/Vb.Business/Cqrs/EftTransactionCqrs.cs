...
namespace Vb.Business.Cqrs
{
    ...
    public record GetEftTransactionByParameterQuery(string SenderIban, string SenderName, string SenderAccount, string Description, string ReferenceNumber) : IRequest<ApiResponse<List<EftTransactionResponse>>>;
}
